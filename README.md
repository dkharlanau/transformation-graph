...
**Executable alpha / v0.18.** Governed project builds, cross-repository adapter conformance, traceability/impact/change intelligence, visual/static publishing, GraphML interoperability, bounded agent access, CI and release readiness are implemented.
